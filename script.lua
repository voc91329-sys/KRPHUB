...
Tab:CreateToggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\210\86\170\67", "\38\156\55\199")]="KHĂ”NG Cáº¦N Cáº¦N GIá»®/TÆ¯Æ NG TĂC",[LUAOBFUSACTOR_DECRYPT_STR_0("\139\104\110\58\22\122\238\117\169\113\105\45", "\35\200\29\28\72\115\20\154")]=false,[LUAOBFUSACTOR_DECRYPT_STR_0("\58\190\221\211\143\45\55\18", "\84\121\223\177\191\237\76")]=function(Value)
...
local function GiveDashTool()
	...
	if backpack:FindFirstChild("CĂ”NG Cá»¤ LÆ¯á»T Tá»I") then
		backpack["CĂ”NG Cá»¤ LÆ¯á»T Tá»I"]:Destroy();
	end
	if (char and char:FindFirstChild("CĂ”NG Cá»¤ LÆ¯á»T Tá»I")) then
		char["CĂ”NG Cá»¤ LÆ¯á»T Tá»I"]:Destroy();
	end
	local tool = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\143\89\198\172", "\161\219\54\169\192\90\48\80"));
	tool.Name = "LÆ¯á»T Tá»I";
...
Tab:CreateButton({[LUAOBFUSACTOR_DECRYPT_STR_0("\146\194\218\15", "\75\220\163\183\106\98")]="NHáº¬N CĂ”NG Cá»¤ LÆ¯á»T",[LUAOBFUSACTOR_DECRYPT_STR_0("\33\187\135\59\219\3\185\128", "\185\98\218\235\87")]=function()
	GiveDashTool();
end});
...
local SavedPos = nil;
local SaveTPButton;
SaveTPButton = Tab:CreateButton({[LUAOBFUSACTOR_DECRYPT_STR_0("\229\61\42\227", "\202\171\92\71\134\190")]="LÆ¯U",[LUAOBFUSACTOR_DECRYPT_STR_0("\10\192\32\132\43\192\47\131", "\232\73\161\76")]=function()
...
Tab:CreateToggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\152\232\39\206", "\167\214\137\74\171\120\206\83")]="Lá»°C Äáº¨Y",[LUAOBFUSACTOR_DECRYPT_STR_0("\168\241\62\81\250\166\136\251", "\199\235\144\82\61\152")]=function(Value)
...
local function toggleESP()
	...
	if espEnabled then
		Rayfield:Notify({[LUAOBFUSACTOR_DECRYPT_STR_0("\37\57\166\52\75", "\73\113\80\210\88\46\87")]=LUAOBFUSACTOR_DECRYPT_STR_0("\170\30\253\82\207\180\14", "\135\225\76\173\114"),[LUAOBFUSACTOR_DECRYPT_STR_0("\57\226\182\164\169\179\179", "\199\122\141\216\208\204\221")]="ÄĂ£ Báº¬T ESP (Tá»‘i Æ°u)!",[LUAOBFUSACTOR_DECRYPT_STR_0("\137\200\2\241\108\255\162\211", "\150\205\189\112\144\24")]=2});
		task.spawn(function()
			while espEnabled do
		...
		Rayfield:Notify({[LUAOBFUSACTOR_DECRYPT_STR_0("\115\197\33\208\1", "\100\39\172\85\188")]=LUAOBFUSACTOR_DECRYPT_STR_0("\134\74\137\192\27\152\90", "\83\205\24\217\224"),[LUAOBFUSACTOR_DECRYPT_STR_0("\197\202\195\41\227\203\217", "\93\134\165\173")]="ÄĂ£ Táº®T ESP!",[LUAOBFUSACTOR_DECRYPT_STR_0("\154\231\211\195\46\199\189\112", "\30\222\146\161\162\90\174\210")]=2});
	end
end
Tab:CreateButton({[LUAOBFUSACTOR_DECRYPT_STR_0("\203\79\125\15", "\106\133\46\16")]="NHĂŒN THáº¤Y Táº¤T Cáº¢ NGÆ¯á»œI CHÆ I",[LUAOBFUSACTOR_DECRYPT_STR_0("\123\33\127\240\88\65\91\43", "\32\56\64\19\156\58")]=function()
	toggleESP();
end});
...
Tab2:CreateButton({[LUAOBFUSACTOR_DECRYPT_STR_0("\119\87\70\248", "\107\57\54\43\157\21\230\231")]="HIá»†U NÄ‚NG",[LUAOBFUSACTOR_DECRYPT_STR_0("\248\138\29\249\187\221\204\208", "\175\187\235\113\149\217\188")]=function()
	pcall(function()
	...
	Rayfield:Notify({[LUAOBFUSACTOR_DECRYPT_STR_0("\100\179\213\183\85", "\219\48\218\161")]=LUAOBFUSACTOR_DECRYPT_STR_0("\207\67\76\9\243\122\194", "\128\132\17\28\41\187\47"),[LUAOBFUSACTOR_DECRYPT_STR_0("\34\61\8\46\88\15\38", "\61\97\82\102\90")]="ÄĂ£ tá»‘i Æ°u toĂ n diá»‡n vĂ  dá»n sáº¡ch Map!",[LUAOBFUSACTOR_DECRYPT_STR_0("\136\59\185\74\211\94\17\7", "\105\204\78\203\43\167\55\126")]=5});
end});
...
local function SetFPS(limit)
	setfpscap(limit);
	Rayfield:Notify({[LUAOBFUSACTOR_DECRYPT_STR_0("\3\82\203\37\133", "\62\87\59\191\73\224\54")]="FPS ÄĂ£ cáº­p nháº­t",[LUAOBFUSACTOR_DECRYPT_STR_0("\196\13\244\221\226\12\238", "\169\135\98\154")]=("Giá»›i háº¡n FPS hiá»‡n táº¡i: " .. limit),[LUAOBFUSACTOR_DECRYPT_STR_0("\239\98\54\85\233\58\199\197", "\168\171\23\68\52\157\83")]=3});
end
...
local Tab3 = Window:CreateTab("SĂ€N DUNG NHAM", nil);
_G.AutoLv1Enabled = false;
local TargetPos = Vector3.new(3549, 89, 741);
Tab3:CreateToggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\114\4\205\170", "\184\60\101\160\207\66")]="BAY Tá»I CHá»” CUá»I",[LUAOBFUSACTOR_DECRYPT_STR_0("\18\151\110\174\52\140\104\138\48\142\105\185", "\220\81\226\28")]=false,[LUAOBFUSACTOR_DECRYPT_STR_0("\48\212\142\247\232\198\16\222", "\167\115\181\226\155\138")]=function(Value)
